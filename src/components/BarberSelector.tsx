...
const BarberSelector = (props, ref) => {
  const [query, setQuery] = useState("");
  const barberInputRef = React.useRef<HTMLInputElement>(null);
  ...
  useEffect(() => {
    if (props.open) {
      if (barberInputRef.current !== null) {
        barberInputRef.current.focus();
      }
    }
  }, [props.open]);
...
export default React.forwardRef(BarberSelector)
